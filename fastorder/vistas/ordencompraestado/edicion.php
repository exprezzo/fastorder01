...
<script>			
	$( function(){		
		var config={
			...
			catalogo:{
				nombre:'ordencompraestado'
			},			
			pk:"idordencompraestado"
			
		};				
		 var editor=new Edicionordencompraestado();
		 editor.init(config);		
	});
</script>
	...
	<div class="pnlIzq">
		...
		<form class="frmEdicion" style="padding-top:10px;">				
			...
			<label style="">idordencompraestado:</label>
			<input type="text" name="idordencompraestado" class="txt_idordencompraestado" value="<?php echo $this->datos['idordencompraestado']; ?>" style="width:500px;" />
