...
<script>			
	$( function(){		
		var config={
		 ...
		 var editor=new Edicionempresasuc();
		 editor.init(config);		
	});
</script>
	...
	<label style="">Idempresasuc:</label>
	<input type="text" name="idempresasuc" class="txt_idempresasuc" value="<?php echo $this->datos['idempresasuc']; ?>" style="width:500px;" />
</div>
<div class="inputBox" style="margin-bottom:8px;display:block;margin-left:10px;width:100%;"  >
