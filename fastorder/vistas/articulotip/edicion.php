...
<script>			
	$( function(){		
		var config={
		 ...
		 var editor=new Edicionarticulotip();
		 editor.init(config);		
	});
</script>
	...
	<div class="pnlIzq">
		...
		<form class="frmEdicion" style="padding-top:10px;">				
			...
			<label style="">idarticulotip:</label>
			<input type="text" name="idarticulotip" class="txt_idarticulotip" value="<?php echo $this->datos['idarticulotip']; ?>" style="width:500px;" />
